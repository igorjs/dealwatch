/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9aa444485c1881685151d0692a24335d)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	LIST: R2Bucket;
	DB: D1Database;
	// Secrets, set via `wrangler secret put <NAME>` at deploy time. They are
	// not declared in wrangler.jsonc, so `wrangler types` does not generate
	// them automatically: hand-added here and re-added on every regen.
	API_TOKEN: string;
